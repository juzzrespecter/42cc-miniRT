...
t_vector array_to_color(char *color);
...
bool build_cam(char **scene_line, t_objects *o_lst);
bool build_plane(char **scene_line, t_objects *o_lst);
bool build_square(char **scene_line, t_objects *o_lst);
bool build_triangle(char **scene_line, t_objects *o_lst);
